            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
               ...
               <input type="hidden" value="<?php echo site_url('Dashboard/upload');?>" id="ckeditor_img_url" >
                ...
                <form action="<?php echo site_url('Dashboard/editpartners');?>" method="post" id="EditFormCourse" enctype="multipart/form-data">
              ...
              if(file_exists('upload/parnters/'. $pages[0]['FeaturedImage']))
                  { ?>
                  <div class="form-group" style="" id="featuredimagefiled">
                    <label>Featrured Image</label>
                   <img src="<?php echo base_url('upload/parnters');?>/<?php echo $pages[0]['FeaturedImage'];?>" style="with:20%; height:auto"/>

                   <a href="javascript:void(0)" onclick="change_image('<?php echo $pages[0]['FeaturedImage'];?>','<?php echo site_url('Dashboard/change_image');?>','parnters')" class="btn btn-danger btn-sm pull-right align-middle">Change Image</a>
