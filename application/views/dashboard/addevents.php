<div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <input type="hidden" value="<?php echo site_url('Dashboard/ajax_check_unique');?>" id="ajax_check_unique" >
                <form action="<?php echo site_url('Dashboard/addevents');?>" method="post" id="FormSubmit" enctype="multipart/form-data">
                  <div class="form-group">
                    <label>Event Title</label>
                    <input type="text" class="form-control" placeholder="Page Title" id="title" name="title" value="<?=set_value('title')?>" required>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="content_url" placeholder="page url" name="content_url" value="<?=set_value('content_url')?>" required>
                    <span class="text-danger custom_error" id="content_url_error"> <?php echo form_error('content_url'); ?></span>
                  </div>

                  <div class="form-group">
                    <label>Event Body</label>
                    <textarea name="editor1" class="form-control" placeholder="Page Body" required>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="meta_data" placeholder="Add Meta Description..." name="meta_data" value="<?=set_value('meta_data')?>" required>
