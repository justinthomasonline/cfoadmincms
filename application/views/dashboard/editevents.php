            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
               ...
               <input type="hidden" value="<?php echo site_url('Dashboard/upload');?>" id="ckeditor_img_url" >
                ...
                <form action="<?php echo site_url('Dashboard/editevents');?>" method="post" id="EditFormSubmit" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <option value="upcoming" <?php if($pages[0]['category']=="upcoming")  echo "selected";?> >Upcoming</option>
                    <option value="past" <?php if($pages[0]['category']=="past")  echo "selected";?>>Past</option>
                    </select>
              ...
              <!--     <?php if($pages[0]['FeaturedImage']!="")
                  { ?>
                  <div class="form-group" style="">
                    <label>Featrured Image</label>
                   <img src="<?php echo base_url('upload');?>/<?php echo $pages[0]['FeaturedImage'];?>" style="with:20%; height:auto"/>
                  </div>
                <?php }else { ?>
